...
function handleModalOpen(){
  ...
  return (
    <>       
         <Head> <title>Acessível web</title>  </Head>          
         <header className={styles.header}>
            <Image src={LogoImg} width={286/2} alt="Blog da Rocketseat "/>

            <nav className={styles.nav}>
              <a href="https://github.com/michellepachecoweb" aria-label="Github">
        ...
        <main>
           <article className={styles.content}>
                <header> 
                    <h1>Desenvolvendo uma web acessivel - 2024</h1>
                    <h2>Protocolos e diretrizes orientam Lorem ipsum dolor</h2>
                </header>
                <p>sit amet consectetur adipisicing elit. Quasi impedit earum maiores sint natus, minima reiciendis, nulla possimus modi, dolorum soluta laudantium. Reprehenderit veniam eius, fuga distinctio enim culpa dignissimos. </p>
                <p>sit amet consectetur adipisicing elit. Quasi impedit earum maiores sint natus, minima reiciendis, nulla possimus modi, dolorum soluta laudantium. Reprehenderit veniam eius, fuga distinctio enim culpa dignissimos. </p>
                <p>sit amet consectetur adipisicing elit. Quasi impedit earum maiores sint natus, minima reiciendis, nulla possimus modi, dolorum soluta laudantium. Reprehenderit veniam eius, fuga distinctio enim culpa dignissimos. </p>
                <p>sit amet consectetur adipisicing elit. Quasi impedit earum maiores sint natus, minima reiciendis, nulla possimus modi, dolorum soluta laudantium. Reprehenderit veniam eius, fuga distinctio enim culpa dignissimos. </p>
